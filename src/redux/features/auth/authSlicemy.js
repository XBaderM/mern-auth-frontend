...
import authService from "./authServicemy";
...
//regisre user
//userdata coming from axios authservice
...
//userdata coming from axios authservice
//error messages sent to frontend
//_ to represent no data not sending to backend
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(logout.fulfilled, (state, action) => {
        ...
        state.user = null;
        console.log(action.payload);
        //information from backend action.payload message:json
